...
$select_query="select * from projects where bid='".$_SESSION['fbran']."'";
...
<?php
 ...
 {
	?>
<panel><pre><h3><br><br><br>         This are the Projects in your Branch:</h3></pre></panel>
<?php	
...
//for rno
	...
	$_SESSION['sid']=$check_email1['sid'];
	 ...
	 ?>
            ...
            <table class="table table-hover">
                <tbody>
					...
					<th><?PHP if($_SESSION['BranchId']==1){echo "COMPS";}
							  if($_SESSION['BranchId']==2){echo "IT";}
							  if($_SESSION['BranchId']==3){echo "CIVIL";}
						?> </th>
		...
		?>
		<p align="center" style=" margin-bottom:4%;" ><b>TOTAL NO OF PROJECTS</b><br><br>
